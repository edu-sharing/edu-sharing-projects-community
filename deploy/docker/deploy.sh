...
info() {
	...
	echo ""
	echo "    Name:           ${MONGO_DATABASES_ROOT_USER:-root}"
	echo "    Password:       ${MONGO_DATABASES_ROOT_PASS:-root}"
	echo ""
	echo "  repository database:"
	echo ""
	echo "    Name:           ${REPOSITORY_MONGO_USER:-repository}"
	echo "    Password:       ${REPOSITORY_MONGO_PASS:-repository}"
	echo "    Database:       ${REPOSITORY_MONGO_DATABASE:-repository}"
	echo ""
	echo "  Port:             127.0.0.1:${MONGO_DATABASE_PORT:-9106}"
	echo ""
	echo "#########################################################################"
	echo ""
