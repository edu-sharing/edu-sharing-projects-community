...
info() {
	...
	echo "  JVM:"
	echo ""
	echo "    XMS:            ${REPOSITORY_SEARCH_SOLR4_JAVA_XMS:-512m}"
	echo "    XMX:            ${REPOSITORY_SEARCH_SOLR4_JAVA_XMX:-512m}"
	echo ""
	echo "  Services:"
	echo ""
	...
	echo "  JVM:"
	echo ""
	echo "    XMS:            ${REPOSITORY_SERVICE_JAVA_XMS:-2g}"
	echo "    XMX:            ${REPOSITORY_SERVICE_JAVA_XMX:-4g}"
	echo ""
	echo "  Services:"
	echo ""
